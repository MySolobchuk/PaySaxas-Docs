...
| Method | Endpoint                                                           | Description                                                                                              |
|--------|--------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| GET    | [`/transactions`](../OpenAPI/transactions/listTransactions)        | Lists all incoming transactions (SEPA IN, internal transfers, refunds).                                  |
...
[See the OpenAPI webhook definition →](OpenAPI/payments/paymentevents)