...
| Method | Endpoint                                                         | Description                                                |
|--------|------------------------------------------------------------------|------------------------------------------------------------|
| POST   | [`/accounts/{id}/ibans`](../OpenAPI/accounts/issueNewIban)       | Issues a new virtual IBAN linked to the specified account. |
| GET    | [`/accounts/{id}/ibans`](../OpenAPI/accounts/listIbansByAccount) | Returns all virtual IBANs associated with the account.     |
...
[See the OpenAPI webhook definition →](../OpenAPI/accounts/deliverAccountsIbanWebhook)
