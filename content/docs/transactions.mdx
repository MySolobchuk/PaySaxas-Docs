...
| reversed   | Funds refunded or reversed after rejection.              |
...
|--------|--------------------------------------------------------------------|--------------------------------------------------------|
| GET    | [`/transactions`](../OpenAPI/transactions/listTransactions)        | Returns a list of transactions filtered by parameters. |
| GET    | [`/transactions/{id}`](../OpenAPI/transactions/getTransactionById) | Returns full transaction details.                      |

### Webhooks — Transaction Events

[See the OpenAPI webhook definition →](../OpenAPI/transactions/deliverTransactionWebhook)
